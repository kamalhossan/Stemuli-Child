...
query_posts('post_type=post&category_name=release&post_status=publish&posts_per_page=-1&order=DESC' . get_query_var('post')
);


?>

<div class="row cs_post press_release cat_release">
        ...
        <div class="post_column">
            ...
            <div class="post_content">
              ...
              <div class="categories">
                <p class="post-meta"><span class="published"> <?php echo the_time('M j, Y'); ?></span> | Press Release</p>
<!-- 
